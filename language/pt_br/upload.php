...
$lang = array_merge($lang, array(
	...
	'ACP_UPLOAD_EXT_DESCRIPTION'		=> 'Instale/atualize/delete extensões, gerencie seus arquivos ZIP e muito mais sem usar o FTP.',
	'ACP_UPLOAD_EXT_TITLE_EXPLAIN'		=> 'Upload Extensions permite fazer o envio de arquivos zip de extensões ou deletar pastas de extensões do servidor.<br /> Com essa extensão, você pode instalar/atualizar/deletar extensões sem usar o FTP. Se a extensão carregada já existir, ela será atualizada com os arquivos enviados.',
	...
	'EXTENSION_DELETE'					=> 'Deletar extensão',
	'EXTENSION_DELETE_CONFIRM'			=> 'Você tem certeza que deseja deletar a extensão “%s”?',
	'EXTENSIONS_DELETE_CONFIRM'			=> array(
		2	=> 'Você tem certeza que deseja deletar essas extensões <strong>%1$s</strong>?',
	),
	'EXT_DELETE_SUCCESS'				=> 'A extensão foi deletada com sucesso.',
	'EXTS_DELETE_SUCCESS'				=> 'As extensões foram deletadas com sucesso.',
	...
	'EXTENSION_ZIP_DELETE'				=> 'Deletar arquivo zip',
	'EXTENSION_ZIP_DELETE_CONFIRM'		=> 'Você tem certeza que deseja deletar o arquivo zip “%s”?',
	'EXTENSIONS_ZIP_DELETE_CONFIRM'		=> array(
		2	=> 'Você tem certeza que deseja deletar os arquivos zip <strong>%1$s</strong>?',
	),
	'EXT_ZIP_DELETE_SUCCESS'			=> 'O arquivo zip da extensão foi deletado com sucesso.',
	'EXT_ZIPS_DELETE_SUCCESS'			=> 'Os arquivos zip das extensões foram deletados com sucesso.',
	...
	'ACP_UPLOAD_EXT_ERROR_TRY_SELF'		=> '“Upload Extensions” pode ser atualizado apenas pelo atualizador especial ou pelo FTP.',
	...
	'EXT_PURGE'							=> 'Deletar os dados da extensão',
	'EXT_PURGED'						=> 'Os dados da extensão foram deletados com sucesso.',
	...
	'ACP_UPLOAD_EXT_MANAGER_EXPLAIN'	=> 'O Gerenciador de Extensões do Upload Extensions é uma ferramenta no seu Fórum phpBB que permite gerenciar todas as suas extensões e visualizar informações sobre elas.',
	'ACP_UPLOAD_ZIP_TITLE'				=> 'Gerenciamento de arquivos ZIP',
	'ACP_UPLOAD_UNINSTALLED_TITLE'		=> 'Deletar extensões',
	...
	'EXT_LANGUAGE_DELETE_CONFIRM'		=> 'Você tem certeza que deseja deletar o pacote de idioma “%s”?',
	'EXT_LANGUAGES_DELETE_CONFIRM'		=> array(
		2	=> 'Você tem certeza que deseja deletar os pacotes de idiomas <strong>%1$s</strong>?',
	),
	'EXT_LANGUAGE_DELETE_SUCCESS'		=> 'O pacote de idioma da extensão foi deletado com sucesso.',
	'EXT_LANGUAGES_DELETE_SUCCESS'		=> 'Os pacotes de idiomas da extensão foram deletados com sucesso.',
	...
	'EXT_TOOLS_DOWNLOAD_DELETE_SUFFIX'	=> 'Delete o sufixo de desenvolvimento, se existir',
	...
	'UPLOAD_DESCRIPTION_MANAGE'			=> 'Gerenciar extensões do phpBB',
	...
	'UPLOAD_DESCRIPTION_ZIP_SAVE'		=> 'Salve zips em um diretório de sua escolha',
	'UPLOAD_DESCRIPTION_ZIP_UNPACK'		=> 'Descompacte um arquivo zip para instalar uma extensão',
	...
	'UPLOAD_DESCRIPTION_CLEANER_ABOUT'	=> 'Você pode deletar diretórios de extensão ou arquivos zip de extensões do servidor.',
));
